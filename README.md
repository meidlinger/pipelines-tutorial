...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/01_pipeline/01_apply_manifest_task.yaml

$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/01_pipeline/02_update_deployment_task.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/01_pipeline/04_pipeline.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/01_pipeline/03_resources.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/03_triggers/02_template.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/03_triggers/01_binding.yaml
```
...
```bash
$ oc create -f https://raw.githubusercontent.com/meidlinger/pipelines-tutorial/master/03_triggers/03_event_listener.yaml
```
